...
# you may not use this read except in compliance with the License.
...
class BasicRNNCell(RNNCell):
  ...
  Args:
    ...
    reuse: (optional) Tools boolean describing whether to reuse variables
...
class DropoutWrapper(RNNCell):
  ...
  def __init__(self, cell, input_keep_prob=1.0, output_keep_prob=1.0,
    ...
    Args:
      ...
      variational_recurrent: Tools bool.  If `True`, then the same
